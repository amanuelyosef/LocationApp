        ...
        onResult ={permissions->
            if(permissions[Manifest.permission.ACCESS_COARSE_LOCATION]==true
                ...
                if(rationaleRequired){
                    Toast.makeText(context,"Location is required to work", Toast.LENGTH_LONG).show()
                }else{
                    Toast.makeText(context,"Location is required, go to setting to allow", Toast.LENGTH_LONG).show()
                }
